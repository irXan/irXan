...
class IrzanAhmad extends FlutterDeveloper {
  ...
  final String title    = "Flutter Dev / Vibe Coder";
  final String base     = "Karachi, Pakistan 🇵🇰";

  final List<String> building = [
    "📱  Cross-platform apps  →  Flutter & Dart",
    "🔥  Backend              →  Firebase & Supabase",
    "🌐  Full-Stack           →  MERN Stack",
    "🤖  Expanding into       →  AI, Data Science & FinTech",
  ];

  final Map<String, String> facts = {
    "architecture" : "Clean. Scalable. Maintainable.",
    "ui_style"     : "Responsive. Pixel-perfect. Fast.",
    "approach"     : "Structured code. Real problem solving.",
  };

  String motto() => "Ship it. Learn from it. Build better. 🚀";
}
```
...
[![Email](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:irzanahmad44@gmail.com)
